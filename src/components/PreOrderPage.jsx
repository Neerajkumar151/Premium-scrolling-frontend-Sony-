...
const CountdownTimer = () => {
  ...
  const TimeUnit = ({ value, label }) => (
    <div className="flex flex-col items-center">
      <span className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold font-mono tracking-tighter">
        {String(value).padStart(2, '0')}
      </span>
      <span className="text-[8px] sm:text-[9px] md:text-[10px] lg:text-xs uppercase tracking-[0.2em] sm:tracking-[0.3em] text-white/40 mt-1 sm:mt-2">
        {label}
      </span>
    </div>
  );
  ...
  return (
    <div className="flex gap-4 sm:gap-6 md:gap-10 lg:gap-16 justify-center py-8 sm:py-10 md:py-12 border-y border-white/10 backdrop-blur-sm bg-white/5 rounded-2xl sm:rounded-3xl">
...
const BenefitCard = ({ icon: Icon, title, desc }) => (
  <ScrollReveal className="p-6 sm:p-8 rounded-2xl sm:rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-500 group">
    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-accent-blue/20 flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
      <Icon className="text-accent-blue w-5 h-5 sm:w-6 sm:h-6" />
    </div>
    <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3">{title}</h3>
    <p className="text-white/50 leading-relaxed font-light text-sm sm:text-base">{desc}</p>
  </ScrollReveal>
);
  ...
  return (
    <div className="relative min-h-screen text-white font-sans selection:bg-accent-blue selection:text-white">
      ...
      <div className="relative z-10">
        ...
        <section className="relative pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 md:px-12 overflow-hidden">
          ...
          <div className="max-w-[1200px] mx-auto relative z-10 text-center">
            ...
            <ScrollReveal delay={0.1}>
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-bold tracking-tighter mb-4 sm:mb-6 bg-clip-text text-transparent bg-gradient-to-b from-white to-white/40">
            ...
            {/* Countdown Container */}
            <ScrollReveal delay={0.3} className="max-w-sm sm:max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto mb-16 sm:mb-20 md:mb-24">
              <CountdownTimer />
            </ScrollReveal>
        ...
        {/* --- BENEFITS GRID --- */}
        <section className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-12 max-w-[1200px] mx-auto">
          <ScrollReveal className="mb-10 sm:mb-12 md:mb-16 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold mb-3 sm:mb-4">Why Pre-Order?</h2>
            <p className="text-white/50 text-sm sm:text-base">Join the elite few who experience it first.</p>
          </ScrollReveal>
        ...
        <section className="py-16 sm:py-24 md:py-32 bg-white/5 border-t border-white/10">
          <div className="max-w-[800px] mx-auto px-4 sm:px-6 text-center">
            ...
            <ScrollReveal>
              ...
              <p className="text-base sm:text-lg md:text-xl text-white/60 mb-8 sm:mb-10 md:mb-12 font-light">
                No payment required today. We will notify you when your reserved unit is ready for checkout.
              </p>
            </ScrollReveal>

            <ScrollReveal delay={0.2} className="relative max-w-md sm:max-w-lg mx-auto">
              {isSubmitted ? (
                <div className="bg-green-500/10 border border-green-500/20 text-green-400 p-6 sm:p-8 rounded-2xl sm:rounded-3xl animate-in fade-in zoom-in duration-500">
                  <h3 className="text-xl sm:text-2xl font-bold mb-2">You're on the list.</h3>
                  <p className="opacity-80 text-sm sm:text-base">Check your inbox for your reservation ID.</p>
                </div>
              ) : (
